...
%o`, message, error2, detail);
  ...
  // source/javascripts/controllers/chatbot_controller.js
  var chatbot_controller_default = class extends Controller {
    static targets = [
      "container",
      "toggleButton",
      "closeButton",
    ...
    async sendMessage() {
      ...
      try {
        ...
        console.error("Chat API error:", error2);
      } finally {
    ...
    handleOutsideClick(event) {
      if (this.isOpenValue && !this.element.contains(event.target) && (!this.hasToggleButtonTarget || !this.toggleButtonTarget.contains(event.target))) {
        this.close();
      }
    }
    preventClose(event) {
  ...
  // source/javascripts/controllers/index.js
  var application = Application.start();
  application.register("chatbot", chatbot_controller_default);
})();
